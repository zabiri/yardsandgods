  ...
  return (
    <section className="About">
      <div className="About__container">
        ...
        <p className="About__container-paragraph">
          Yards & Gods was formerly a mixed-media collective based in Columbia, MO
        ...
        <p className="About__container-paragraph">
          ...
          . I am a/an: audio engineer, musician, web developer, audiophile,
          technophile, cat enthusiast, video editor, animator, trekkie, etc… I
          have been recording music and engineering live sound for over half of
          my life. I operate a modest digital recording studio in my home for
